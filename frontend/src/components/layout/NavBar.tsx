    ...
    <>
      <header
        className={`sticky top-0 z-50 w-full transition-all duration-300 ${
          scrolled
            ? 'bg-[#030712]/90 backdrop-blur-xl border-b border-white/8 shadow-[0_4px_30px_rgba(0,0,0,0.5)]'
            ...
            {isLoggedIn ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs font-semibold text-gray-400 hover:text-red-400 px-3 py-2 rounded-lg border border-white/8 hover:border-red-400/30 bg-white/3 hover:bg-red-500/5 transition-all"
                >
      ...
      <AnimatePresence>
        {mobileOpen && isLoggedIn && (
          <motion.div
            ...
            className="md:hidden sticky top-[57px] z-40 w-full bg-[#030712]/95 backdrop-blur-xl border-b border-white/8 overflow-hidden"
          >
